    ...
    return (
      <>
        <TextField
          ...
          helperText={errors.hasOwnProperty("name") ? "Enter valid name" : ""}
          margin="normal"
          required
          fullWidth
          id="name"
        ...
        <TextField
          ...
          helperText={errors.hasOwnProperty("email") ? "Enter valid email" : ""}
          margin="normal"
          required
          fullWidth
          id="email"
        ...
        <TextField
          ...
          helperText={
            errors.hasOwnProperty("password") ? "Enter valid Password" : ""
          }
          margin="normal"
          required
          fullWidth
        ...
        <TextField
          ...
          helperText={
            errors.hasOwnProperty("gstIn") ? "Enter valid Gst Number" : ""
          }
          margin="normal"
          key="gstIn"
          required
    ...
    return (
      <>
        <TextField
          ...
          helperText={
            errors.hasOwnProperty("addressLine1") ? "Enter valid address" : ""
          }
          margin="normal"
          required
          fullWidth
        ...
        <TextField
          ...
          helperText={
            errors.hasOwnProperty("pincode") ? "Enter valid address" : ""
          }
          margin="normal"
          required
          fullWidth
        ...
        <TextField
          ...
          helperText={
            errors.hasOwnProperty("state") ? "Enter valid address" : ""
          }
          margin="normal"
          required
          fullWidth
