      ...
      <Paper elevation={5}>
        <Grid container p={2} pt={0} mt={2} rowSpacing={3}>
          ...
          {orderDetail.customerName && (
            <GridItem title="Customer Name:" value={orderDetail.customerName} />
          )}
          <GridItem
            title={"Order Status:"}
            value={orderDetail.orderStatus}
            sx={{
              backgroundColor: getColor(orderDetail.orderStatus),
          ...
          />
          <GridItem value={"₹" + orderDetail.price} title={"Order Price:"} />
